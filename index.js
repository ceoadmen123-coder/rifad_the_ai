...
// ── RIFAD THE AI System Prompt ──
const SYSTEM_PROMPT = `তুমি হলে "RIFAD THE AI" — একজন বন্ধু এবং সাহায্যকারী।
...
// ── State ──
let logs      = ['🚀 RIFAD THE AI starting up...'];
...
<title>RIFAD THE AI — WhatsApp Bot Terminal</title>
...
<div class="header">
  ...
  <div>
    <div class="title">RIFAD THE AI</div>
...
<div class="footer">
  <div class="dev">『 R I F A D 』</div>
  <a href="https://t.me/MR_RIFAD" target="_blank" rel="noopener">📩 t.me/mr_ali_babas</a>
  <div class="tag">DEVELOPED · MAINTAINED · POWERED BY RIFAD</div>
</div>
...
async function startWhatsAppBot() {
    ...
    sock.ev.on('connection.update', (update) => {
        ...
        if (connection === 'open') {
            ...
            pairingCode       = null;
            reconnectAttempts = 0;
            pushLog('🎊 RIFAD THE AI is ONLINE on WhatsApp!');
        }
